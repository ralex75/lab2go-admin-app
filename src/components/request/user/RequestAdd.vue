...
let userForm=reactive({"name":user.value.name,"surname":user.value.surname,"email":user.value.email,"emailAlt":[],"discipline":[],"notes":""})
const doSave=()=>{
    ...
    saveRequest({school:schoolForm,user:userForm})
